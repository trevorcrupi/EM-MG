function [solution,MGErrorConvergenceRate,numOfMGIterations] = MGMainWithParameter(inputUVector,globalB, meshNum, storingA, storingEdge, storeNodeNums,storeHeights)
