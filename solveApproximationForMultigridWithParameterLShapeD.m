function [c,globalA,height,numOfNodes,MGErrorConvergenceRate,numOfMGIterations] = solveApproximationForMultigridWithParameterLShapeD(p,e,t,numOfTriangles,k,edge,meshNum,storingA,storingEdge,storeNodeNums,storeHeights,parameter)
...
%     c = MG(inputUVector,testB, meshNum, storingA, storingEdge, storeNodeNums,storeHeights);
    [c,MGErrorConvergenceRate,numOfMGIterations] = MGMainParameterLShapeD(inputUVector,testB, meshNum, storingA, storingEdge, storeNodeNums,storeHeights, numOfTriangles, p, t, edge, k);
