...
% [c,globalA,height,numOfNodes] = solveApproximationForMultigrid(p,e,t,numOfTriangles(n),k,edge,n,storingA,storingEdge,storeNodeNums,storeHeights);
    ...
    [c,globalA,height,numOfNodes,MGErrorConvergenceRate,numOfMGIterations1] = solveApproximationForMultigridWithParameter(p,e,t,numOfTriangles(n),k,edge,n,storingA,storingEdge,storeNodeNums,storeHeights,parameter);
    storingA{n}                = globalA;
...
%save('9MeshResults_UnitSquare_Parameter10000', 'MeshLevel', 'SizeOfDimForMG', 'NumOfMGIterations', 'ErrorConvergenceRateForMG');