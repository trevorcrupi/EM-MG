function [solution,MGErrorConvergenceRate,numOfMGIterations] = MGMainParameterParallelogram(inputUVector,globalB, meshNum, storingA, storingEdge, storeNodeNums,storeHeights, numOfTriangles, p, t, edge, k)
...
%                more function outputs.
    ...
    while checkForToleranceMG >= (10^(-15))             % This condition for "Test MG".
        ...
        if(numOfMGIterations > 1)
            newval2       = getHrCurlNormForParameterParallelogram(solution_i, meshNum, numOfTriangles, p, t, edge, k);
