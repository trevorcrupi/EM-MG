function [c,globalA,height,numOfNodes,MGErrorConvergenceRate,numOfMGIterations] = solveApproximationForMultigridWithParameterParallelogram(p,e,t,numOfTriangles,k,edge,meshNum,storingA,storingEdge,storeNodeNums,storeHeights,parameter)
     ...
     for i = 1:numOfTriangles
        ...
        for o = 1:3
            for j = 1:3
                ...
                ourPhi_j3 = phiLine3();
                localA(o,j) = Wx' * getIntegrandWithParameter(ourPhi_i1, ourPhi_i2, ourPhi_i3, ourPhi_j1, ourPhi_j2, ourPhi_j3, localPhiCoeffs(:,o), localPhiCoeffs(:,j), X, Y, k, 1, parameter) * Wy;
            end
        end
        for o = 1:3
            for j = 4:6
                ...
                localA(o,j) = Wx' * getIntegrandWithParameter(ourPhi_i1, ourPhi_i2, ourPhi_i3, ourPsi_j1, ourPsi_j2, ourPsi_j3, localPhiCoeffs(:,o), localPsiCoeffs(:,j-3), X, Y, k, 2, parameter) * Wy;
            end
        end
        for o = 4:6
            for j = 1:3
                ...
                ourPhi_j2 = phiLine2( localPhiCoeffs(:,j)  , X, Y );
                ourPhi_j3 = phiLine3();
                localA(o,j) = Wx' * getIntegrandWithParameter(ourPsi_i1, ourPsi_i2, ourPsi_i3, ourPhi_j1, ourPhi_j2, ourPhi_j3, localPsiCoeffs(:,o-3), localPhiCoeffs(:,j), X, Y, k, 3, parameter) * Wy;
            end
        end
        for o = 4:6
            for j = 4:6
                ...
                ourPsi_j2 = psiLine2();
                ourPsi_j3 = psiLine3( localPsiCoeffs(:,j-3), X );
                localA(o,j) = Wx' * getIntegrandWithParameter(ourPsi_i1, ourPsi_i2, ourPsi_i3, ourPsi_j1, ourPsi_j2, ourPsi_j3, localPsiCoeffs(:,o-3), localPsiCoeffs(:,j-3), X, Y, k, 4, parameter) * Wy;
            end
        end
        localA;
...
%     c = MG(inputUVector,testB, meshNum, storingA, storingEdge, storeNodeNums,storeHeights);
    [c,MGErrorConvergenceRate,numOfMGIterations] = MGMainParameterParallelogram(inputUVector,testB, meshNum, storingA, storingEdge, storeNodeNums,storeHeights, numOfTriangles, p, t, edge, k);
