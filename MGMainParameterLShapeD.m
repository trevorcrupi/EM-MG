function [solution,MGErrorConvergenceRate,numOfMGIterations] = MGMainParameterLShapeD(inputUVector,globalB, meshNum, storingA, storingEdge, storeNodeNums,storeHeights, numOfTriangles, p, t, edge, k)
...
%                more function outputs.
    ...
    while checkForToleranceMG >= (10^(-15))             % This condition for "Test MG".
        ...
        if(numOfMGIterations == 1)
           newval1                          = getHrCurlNormForParameterLShapeD(solution_i, meshNum, numOfTriangles, p, t, edge, k);
           normS_iVector(numOfMGIterations) = newval1;
           errors3(numOfMGIterations)       = normS_iVector(numOfMGIterations) / normS_0;
        end
        if(numOfMGIterations > 1)
            newval2       = getHrCurlNormForParameterLShapeD(solution_i, meshNum, numOfTriangles, p, t, edge, k);
